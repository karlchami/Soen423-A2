...
/**
* StoreApp/_DSMSStub.java .
* Generated by the IDL-to-Java compiler (portable), version "3.2"
* from storeApp.idl
* Friday, October 23, 2020 4:50:23 o'clock PM EDT
*/

public class _DSMSStub extends org.omg.CORBA.portable.ObjectImpl implements StoreApp.DSMS
{

  public boolean addItem (String managerID, String itemID, String itemName, int quantity, long price)
  {
  ...
  public void addCustomerWaitList (String customerID, String itemID)
  {
            org.omg.CORBA.portable.InputStream $in = null;
            try {
                org.omg.CORBA.portable.OutputStream $out = _request ("addCustomerWaitList", true);
                $out.write_string (customerID);
                $out.write_string (itemID);
                $in = _invoke ($out);
                return;
                ...
                addCustomerWaitList (customerID, itemID        );
            } finally {
                _releaseReply ($in);
            }
  } // addCustomerWaitList
